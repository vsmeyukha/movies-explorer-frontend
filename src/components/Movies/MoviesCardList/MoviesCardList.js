...
//     {props.filteredMoviesList.length > 12 ? 
//       props.filteredMoviesList.slice(0, 12).map((movie) => {
//       return (
//         <MoviesCard
//           key={movie.id}
//           title={movie.nameRU}
...
return (
  <section className="movies-card-list">
    {props.filteredMoviesList.length > 12 ? 
      props.filteredMoviesList.slice(0, 12).map((movie) => renderCard(movie))
      :
      props.filteredMoviesList.map((movie) => renderCard(movie))
    }
  </section>
);
};
